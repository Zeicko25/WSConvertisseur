...
namespace WSConvertisseur.Controllers.Tests
{
    ...
    public class DevisesControllerTests
    {
        ...
        public void GetById_ExistingIdPassed_ReturnsRightItem()
        {
            ...
            // Act
            var result = controller.GetById(1);// Assert
            ...
            Assert.AreEqual(new Devise(1, "Dollar", 1.08), (Devise?)result.Value, "Devises pas identiques"); //Test de la deviserécupérée
        }
        [TestMethod]
        ...
        public void GetAll_GoodReturn()
        {
            ...
            CollectionAssert.AreEqual(result.ToList(), controller.devises, "Les listes ne sont pas les mêmes"); //Test de l'erreur
        }
